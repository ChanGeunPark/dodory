      ...
      <article className='container mx-auto'>
        <div className='mb-24'>
          ...
          <div className='space-x-2 flex flex-wrap justify-center mt-5'>
            {keyword.map(keyword=>(
              <span className='px-5 py-2 border rounded-full text-zinc-500' key={keyword}>{keyword}</span>
            ))}
          </div>
        </div>
        ...
        <section>
          ...
          <p className='text-zinc-500'>이번달 새로 들어온 다육이 가족을 만나보세요</p>
        ...
        <section className='mt-24'>
          ...
          <div className='flex justify-between mb-9 items-center'>
            ...
            <div className='flex space-x-1'>
              <button type='button' className='py-1 px-5 rounded-full bg-red-400 text-white'>추천순</button>
              <button type='button' className='border py-1 text-zinc-500 px-5 rounded-full'>신상품</button>
              <button type='button' className='border py-1 text-zinc-500 px-5 rounded-full'>낮은가격</button>
              <button type='button' className='border py-1 text-zinc-500 px-5 rounded-full'>높은가격</button>
            </div>
          </div>
          ...
          <div className='w-full'>
            <div className='itemList flex flex-wrap'>
              {items.map(items => (
                <div key={items} className=' w-1/4 mb-16 relative -left-10 pl-10'>
