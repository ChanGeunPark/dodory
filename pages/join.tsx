    ...
    <div className="bg-gray-100 py-16">
      <article className="w-[650px] max-w-full mx-auto">
        <div className="pb-16 text-center">
          <h1 className="text-2xl font-semibold">dodo:&#41;ry 회원가입</h1>
          <p className="mt-3 text-zinc-500">
            간편하게 SNS등으로 신규 가입하세요!
          </p>
        </div>
            ...
            <div>
              <div className="flex items-center mt-5">
                <input
                  ...
                  id="termsOfUse"
                />
                <label htmlFor="termsOfUse" className="text-zinc-500 ml-2">
                  쇼핑몰 이용약관에 모두 동의합니다.(필수)
                </label>
              </div>
              <div className="flex items-center mt-2">
                ...
                />
                <label htmlFor="privacy" className="text-zinc-500 ml-2">
                  개인정보 수집 및 이용에 동의합니다.(필수)
                </label>
              </div>
              <div className="flex items-center mt-2">
                <input type="checkbox" {...register("marketing")} />
                <label className="text-zinc-500 ml-2">
                  마케팅 정보수신 및 활용에 동의합니다.(선택)
                </label>
              </div>
            </div>
          </div>
