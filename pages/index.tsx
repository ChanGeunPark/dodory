...
const Home: NextPage<{ products: Product[] }> = ({ products }) => {
  return (
    <CustomCursorManager>
      ...
      <Layout>
        <main>
          <article className="h-screen w-full overflow-hidden relative bg-[#262650]">
            {/* <Spline scene="https://prod.spline.design/NbqCXT93iwZ3tjAN/scene.splinecode" /> */}
            <h1 className="absolute z-20 left-1/2 -translate-x-1/2 top-[20%] text-center text-white pointer-events-none">
              일상을 도도리와 함께하세요
            </h1>
          </article>
          <article className="banner h-screen w-full overflow-hidden relative bg-[#353535] hidden">
            ...
            <div className="w-full h-full flex items-end">
              <div className="w-full">
                <div className="w-full h-[565px] relative flex justify-end items-end">
                  <img
                    src="/index/main_bh2.png"
              ...
              <img
                ...
                className="absolute bottom-[5%] w-[180px] lg:w-[13%] origin-bottom object1 hidden"
                alt="object1"
              />
              <img
                src="/index/object2.png"
                className="absolute bottom-[15%] w-[150px] lg:w-[12%] left-[23%] origin-bottom object2 hidden"
                alt="object2"
              />
              <img
                src="/index/object3.png"
                className="absolute bottom-[10%] w-[250px] lg:w-[22%] right-0 lg:right-[15%] origin-bottom object3 hidden"
                alt="object3"
              />
              <div className="w-full h-[560px] absolute bottom-0 left-0 z-20 ">
